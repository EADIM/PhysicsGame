...
public class Fase03_ChangePlayerPosition : MonoBehaviour
{
    public Fase03_References references;
    
    GameObject player;
    Fase03_GetProblemInfo gpi;
    Fase03_PlayerController pc;
    Fase03_GameState gms;
    ...
    private void Start() {
        pc = player.GetComponent<Fase03_PlayerController>();
        gms = references.GameState.GetComponent<Fase03_GameState>();
        gpi = references.GameState.GetComponent<Fase03_GetProblemInfo>();
    }
